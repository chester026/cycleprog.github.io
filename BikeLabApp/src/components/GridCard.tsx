...
const styles = makeStyles(theme => ({
  ...
  name: {fontSize: theme.typography.fontSize.lg, fontWeight: '700', color: '#1A1A1A', lineHeight: 17, flexShrink: 1, flex: 1},
  nameMuted: {textDecorationLine: 'line-through', color: '#8E8E93'},
  dot: {width: 7, height: 7, borderRadius: 4},
  footer: {marginTop: theme.spacing[8]},
  barTrack: {height: 5, backgroundColor: '#EBEBED', overflow: 'hidden', marginBottom: theme.spacing[6]},
  barFill: {height: '100%'},
  bottom: {flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between'},
  sub: {fontSize: 9, color: '#8E8E93', fontWeight: '500', flexShrink: 1, marginRight: theme.spacing[4]},
  value: {fontSize: theme.typography.fontSize.md, fontWeight: '800', letterSpacing: -0.2, color: '#1A1A1A'},
}));
